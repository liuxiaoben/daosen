	...
	<div id="addAddress">
		...
		<el-form ref="form" :model="form"  :rules="rules" status-icon label-width="140px" label-position="left">
			...
			<el-row class="pad-top">
				<el-button type="danger" @click="submitForm('form')" size="small">保存</el-button>
...
<script>
	import { getPrivince,getCity,getDic,addAddress } from '../../../api/invoice'
	  		...
	  		submitForm(formName) {
	        	this.$refs[formName].validate((valid) => {
	          		if (valid) {
	            		...
	            		addAddress(addressInfo).then( response => {
...
<style type="text/css">
	...
	#addAddress .el-form .el-radio__input.is-checked .el-radio__inner{
		border-color: #e60012;
    	background: #e60012;
	}
	#addAddress .el-form .el-radio__input.is-checked+.el-radio__label{
		color:#e60012;
	}
	#addAddress .el-form .el-button{
		line-height: 9px;
	}
	#addAddress .el-form .el-form-item .el-form-item__label{
		margin-right: 20px;
	}
	#addAddress .el-form .el-form-item.strong .el-form-item__label{
		/*padding-left: 10px;
	...
	#addAddress .el-form .el-input{
		width:521px;
	}
	#addAddress .el-form .el-select{
		width:157px;
	}
	#addAddress .el-form .el-select .el-input{
		width:100%;
	}
	#addAddress .el-form .el-select:last-child .el-input{
		margin-right: 0;
	}
	#addAddress .el-form .el-form-item__error{
		left: 18px;
		color:#e60012;
	}
	#addAddress .el-form-item.is-required .el-form-item__label:before{
		color:#e60012;
	}
	#addAddress .strong>.el-form-item__content{
		width:725px;
	}
</style>
