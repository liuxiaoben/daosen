<template>
    <div id="putAdShopCart">
        <el-form :model="orderForm">
            <div>
                <el-button type="text" class="shop-title"  @click="orderInfoShow = !orderInfoShow"><img src="/src/assets/images/sshd.png" style=""/>订单信息</el-button>
            ...
            <div>
                <el-button type="text" class="shop-title"  @click="meidiaInfoShow = !meidiaInfoShow"><img src="/src/assets/images/sshd.png" style=""/>已选媒体</el-button>
                <transition name="el-zoom-in-top"> 
...
<script>
import { editShopCart, getOrderType } from '@/api/putMap/pushadvertising.js'
export default {
    props: {
        shopCartData:{
            type: Array,
    ...
    methods: {
        ...
        dateChange(val){
            if(val){
                this.orderForm.beginDate = val[0] + ' 00:00:00';
                this.orderForm.endDate = val[1] + ' 00:00:00';
            }
        },
        ...
        submitShopCart(){
            this.$refs['orderForm'].validate((valid) => {
                if (valid) {
                    ...
                    this.orderForm.orderId = this.$route.query.orderId
                    this.orderForm.cycleListJson = JSON.stringify(cycleData)
                    this.orderForm.money = this.shopNumData.tatolPrice
                    this.orderForm.tenantId = this.serverComyId || this.orderInfo.tenantId;
                    this.orderForm.industry = this.industryId || this.orderInfo.industry;
                    ...
                    editShopCart(sendData).then(res=>{
                        if(res.success){
    ...
    watch:{
        ...
        orderInfo: {
            handler(val){
                this.dataSE = [val.beginDate, val.endDate]
                for( var key in val ){
